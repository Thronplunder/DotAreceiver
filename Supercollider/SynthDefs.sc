+ DotaOSC {
	loadSynthDefs{
		...
		SynthDef(\Background, {|freq, amp = 0.05, direGold = 1, direXP = 1, radGold = 1, radXP = 1, lagTime = 1|
		...
		SynthDef(\RadiantHero, {|amp = 1, detune = 0, lagTime = 5|
		...
		SynthDef(\DireHero, {|amp = 0.05, detune = 0, lagTime = 5|
